  ...
  return (
    <div className="grid items-center">
      ...
      <div className="flex justify-center gap-4">
        ...
        {/* pokemons */}
        <div className="min-w-[1080px] bg-elementbBg dark:bg-bgColor dark:bg-opacity-50 dark:border-white dark:shadow-shadow_w bg-opacity-50 rounded-xl border-2 border-elementbBg shadow-shadow font-code p-6 grid grid-cols-4  gap-8  justify-items-center relative">
          {/* Load more button */}
          {moreCanBeLoaded && (
