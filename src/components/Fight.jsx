  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        {/* title */}
        <div className="flex justify-between font-pokefont text-5xl w-[1080px] h-[80px] p-4 rounded-xl bg-pokefigt border-2 border-pokefigt bg-opacity-50 shadow-shadow">
          <span>Fight</span>
          <img
        ...
        {/* content */}
        <div className="min-w-[1080px] bg-elementbBg bg-opacity-50 rounded-xl border-2 border-elementbBg shadow-shadow font-code p-6 flex flex-col items-center gap-4 justify-items-center relative mb-[100px]">
          {/* player names */}
          ...
          <div className="w-full flex justify-between px-8 relative">
            <div className="fight_pokemon_select relative w-[240px] h-[210px] bg-elementbBg rounded-xl border-2 border-elementbBg overflow-hidden transition-all duration-300 ease-linear cursor-pointer"></div>
            {/* pokemon fight stats */}
            <div className="flex flex-col justify-between">
              {/* hp */}
              <div className="w-[390px] h-[24px] relative flex justify-center items-center rounded-xl bg-elementbBg">
              ...
              {/* attack */}
              <div className="pokemon_fight_stats w-[390px] h-[24px] relative flex justify-center items-center rounded-xl bg-elementbBg">
                <div className="w-1/2 h-[24px] relative">
            ...
            <div className="w-[240px] h-[210px] bg-elementbBg rounded-xl border-2 border-elementbBg"></div>
          </div>
          {/* button to start fight */}
          <div className="fight_pokemon w-[430px] h-[95px] flex justify-center items-center font-pokefont text-3xl bg-elementbBg bg-opacity-50 rounded-xl border-2 border-elementbBg shadow-shadow transition-all duration-300 ease-linear cursor-pointer overflow-hidden relative my-14">
